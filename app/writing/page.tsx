  ...
  return (
    <PageLayout>
      ...
      <p>
          ...
          <em>Sep 2025 | through the doing, we are undone and remade. my reflection of summer 2025.</em>
        </p>
      ...
      <p>
          ...
          <em>May 2025 | the gentle power of being understood by a friend.</em>
        </p>
        ...
        <p>
          ...
          <em>Apr 2025 | a few notes from the quiet architecture of ordinary days.</em>
        </p>
        ...
        <p>
          ...
          <em>Aug 2022 | a collection of 24 principles i wrote in high school for the younger version of me.</em>
        </p>
      </div>
    </PageLayout>
  );
